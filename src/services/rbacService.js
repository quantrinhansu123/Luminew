...
export const MODULE_PAGES = {
    ...
    'MODULE_FINANCE': {
        ...
        pages: [
            ...
            { code: 'FINANCE_ORDERS_BACKUP', name: 'Backup đơn hàng 2025 (HN)', path: '/backup-don-2025' },
            { code: 'FINANCE_ORDERS_BACKUP_HCM', name: 'Backup đơn hàng 2025 (HCM)', path: '/backup-don-2025-hcm' }
        ]
    },
    'MODULE_ADMIN': {
        name: 'Admin Tools',
