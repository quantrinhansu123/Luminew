  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-10">
      ...
      <p className="text-[10px] text-gray-400 text-center font-medium italic mt-6">
        * Dữ liệu được tính toán dựa trên các đơn có Mã Đơn Hàng hợp lệ. DS Đi là tổng Tổng tiền VNĐ của các đơn có Trạng thái giao hàng NB: Giao thành công, Giao không thành công, Hoàn hoặc Đang GIAO. Tiền về là số tiền thực nhận đã được Kế toán xác nhận. Ship là tổng cột Phí ship trên các đơn trong phạm vi lọc. Tiền về sau ship = Tiền về − Phí ship.
      </p>
    </div>
  );
}
