-- =====================================================
-- Function lấy dữ liệu Báo Cáo Sale Tổng Hợp (V5 - Fix Date Filter)
-- Updated: Explicitly cast 'date' column to DATE type in WHERE clause
-- to ensure correct comparison regardless of TEXT format (YYYY-MM-DD)
-- =====================================================
...
SELECT 'Function get_sales_analytics V5 (Date Cast Fixed) updated!' as message;
